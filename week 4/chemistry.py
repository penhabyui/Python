...
def main():
    ...
    for symbol, info in periodic_table_dict.items():
        print(f"{symbol}: {info}")
    ...
    print(f"The molar mass of the molecule is: {molar_mass:.5f} g/mol")

    moles = sample_mass / molar_mass
    print(f"The number of moles in the sample is: {moles:.5f} moles")
